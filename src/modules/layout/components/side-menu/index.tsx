...
import SwipeablePanel from "@/modules/layout/components/swipeable-panel/SwipeablePanel";
...
export default function SideMenu() {
    ...
    return (
        <SwipeablePanel
            ...
            direction="left"
            className="fixed top-16 left-0 bottom-0 w-4/5 md:w-80 bg-white shadow-lg overflow-y-auto z-10"
        >
            {/* Quick Filters */}
            <div className="p-4">
                <div className="mb-6">
                    ...
                    <div className="bg-gray-100 p-3 rounded-lg">
                        ...
                        <div className="relative">
                            <input
                                ...
                                min="0"
                                max="12"
                                className="w-full h-[8px] rounded-[4px] bg-gradient-to-r from-[#4ade80] to-[#f87171]"
                            />
                        </div>
