...
export default function FilterButton({style}: { style?: string}) {
    ...
    const iconStyle = "rounded-full m-auto md:m-2 flex-shrink-0 text-white group-active:text-[var(--color-primary)]"

    return (
        <div className={`group rounded-full hover:bg-[var(--color-tertiary)] items-center flex space-around ${style}`}
