...
export default function EmergencyContact({ contact, handleEdit, handleDelete }: ContactProps) {
    return (
        <div className="flex flex-row justify-between items-start md:items-center p-4 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="flex space-x-3 mt-3 md:mt-0">
                <button
                    ...
                    className="text-blue-600 hover:text-blue-800 transition-colors hover:bg-gray-100 rounded-full p-2 cursor-pointer"
                ...
                <button
                    ...
                    className="text-red-600 hover:text-red-800 transition-colors hover:bg-gray-100 rounded-full p-2 cursor-pointer"
